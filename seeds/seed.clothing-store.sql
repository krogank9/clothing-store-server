...
VALUES
  (1, 'Brown shirt', 'This brown shirt is super comfy! Buy today.', 19.99,
    10, 10, 10, 10, NULL),
  (1, 'Flannel', 'Flannels aren''t out of style, order this one today to turn heads in 2020.', 24.99,
    10, 10, 10, 10, NULL),
  (1, 'Nirvana Tee', 'Show your love for the American rock band with this cool graphic tee..', 18.99,
    10, 10, 10, 10, NULL),
  (2, 'Jeans', 'These slim fit jeans are super comfortable.', 24.99,
    10, 10, 10, 10, 10),
  (2, 'Cargo Pants', 'Unlimited pockets... Unlimited possibilities...', 37.99,
    10, 10, 10, 10, 10),
  (3, 'Wool Socks', 'Stay warm all winter with these wool socks.', 9.99,
    10, 10, 10, NULL, NULL),
  (3, 'Banana Socks', 'Let everyone know you love bananas by wearing these socks.', 5.99,
    10, 10, 10, NULL, NULL),
  (4, 'Black Hoodie', 'You can never get enough hoodies! Just buy it.', 19.99,
    10, 10, 10, 10, 10),
  (4, 'Grey Hoodie', 'A variation of the classic black hoodie, in grey this time.', 19.99,
    10, 10, 10, 10, 10),
  (5, 'Blue Backpack', 'Everyone will love this stylish blue blackpack.', 39.99,
...
VALUES
  ...
  (2, 2, 4, NULL, NULL),
  (3, 6, 3, 'Love these socks', 'Wow these socks are the best! They are so warm I don''t even need heating for my house anymore!'),
  (4, 8, 5, 'Best hoodie', 'This hoodie is the best, I''ve worn it for 10 days straight.'),
  (5, 10, 1, 'Awful backpack', 'I hate this backpack, it was so flimsy my dog easily ripped it apart and ate my homework.');